...
import { FormEmailField } from 'src/form/FormEmailField';
...
const meta: Meta<typeof FormEmailField> = {
    ...
    argTypes: {
        ...
        emailErrorMessage: {
            description: 'Error message when user does not write a valid email',
            table: {
                type: { summary: 'string' },
            },
        },
...
type Story = StoryObj<typeof FormEmailField>;
