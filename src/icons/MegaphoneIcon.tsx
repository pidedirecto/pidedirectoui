...
export function MegaphoneIcon({ title, color, width, height, size }: SvgIconProps): React.ReactElement {
    return (
        <svg width={width ?? size ?? 21} height={height ?? size ?? 19} viewBox='0 0 21 19' fill='none' xmlns='http://www.w3.org/2000/svg'>
