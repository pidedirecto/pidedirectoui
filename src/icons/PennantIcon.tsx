...
export function PennantIcon({ title, color, width, height, size }: SvgIconProps): React.ReactElement {
    return (
        <svg width={width ?? size ?? 14} height={height ?? size ?? 16} viewBox='0 0 14 16' fill='none' xmlns='http://www.w3.org/2000/svg'>
            <title>{title}</title>
            <path
