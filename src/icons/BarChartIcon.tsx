...
export function BarChartIcon({ title, width, height, color, size, ...props }: SvgIconProps): React.ReactElement {
    return (
        <svg {...props} width={width ?? size ?? 24} height={height ?? size ?? 22} fill='none' viewBox='0 0 24 22' xmlns='http://www.w3.org/2000/svg'>
