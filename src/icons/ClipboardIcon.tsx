...
export function ClipboardIcon({ color, title, width, height, size }: SvgIconProps): React.ReactElement {
    return (
        <svg width={width ?? size ?? 26} height={height ?? size ?? 20} viewBox='0 0 26 20' fill='none' xmlns='http://www.w3.org/2000/svg'>
