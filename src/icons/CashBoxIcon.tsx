...
export function CashBoxIcon({ width, height, color, title, size, ...props }: SvgIconProps): React.ReactElement {
    return (
        <svg {...props} width={width ?? size ?? 15} height={height ?? size ?? 16} viewBox='0 0 15 16' fill='none' xmlns='http://www.w3.org/2000/svg'>
