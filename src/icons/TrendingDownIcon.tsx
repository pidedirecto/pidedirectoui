...
export function TrendingDownIcon({ title, color, width, height, size, ...props }: SvgIconProps): React.ReactElement {
    return (
        <svg {...props} width={width ?? size ?? 19} height={height ?? size ?? 10} viewBox='0 0 19 10' fill='none' xmlns='http://www.w3.org/2000/svg'>
            <path
