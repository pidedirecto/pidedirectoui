...
export function FoldersIcon({ width, height, color, title, size, ...props }: SvgIconProps): React.ReactElement {
    return (
        <svg {...props} width={width ?? size ?? 21} height={height ?? size ?? 21} xmlns='http://www.w3.org/2000/svg' viewBox='0 0 18 18' fill='none'>
