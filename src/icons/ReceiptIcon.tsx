...
export function ReceiptIcon({ title, color, width, height, size, ...props }: SvgIconProps): React.ReactElement {
    return (
        <svg {...props} width={width ?? size ?? 26} height={height ?? size ?? 26} viewBox='0 0 26 26' fill='none' xmlns='http://www.w3.org/2000/svg'>
