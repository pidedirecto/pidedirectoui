...
export function DocumentIcon({ color, title, width, height, size, ...props }: SvgIconProps): React.ReactElement {
    return (
        <svg {...props} width={width ?? size ?? 30} height={height ?? size ?? 40} viewBox='0 0 30 40' fill='none' xmlns='http://www.w3.org/2000/svg'>
            <title>{title}</title>
            <path
