...
export function DoorHangerIcon({ title, color, width, height, size }: Props): React.ReactElement {
    return (
        <svg width={width ?? size ?? 10} height={height ?? size ?? 15} viewBox='0 0 10 15' fill='none' xmlns='http://www.w3.org/2000/svg'>
            <title>{title}</title>
            <path
