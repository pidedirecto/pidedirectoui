...
export function VideoIcon({ color, title, width, size, height, ...props }: SvgIconProps): React.ReactElement {
    return (
        <svg {...props} width={width ?? size ?? 24} height={height ?? size ?? 20} viewBox='0 0 24 20' fill='none' xmlns='http://www.w3.org/2000/svg'>
