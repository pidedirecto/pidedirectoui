...
export function EnvelopeIcon({ title, color, size, width, height, ...props }: SvgIconProps): React.ReactElement {
    return (
        <svg {...props} width={width ?? size ?? 18} height={height ?? size ?? 14} viewBox='0 0 18 14' fill='none' xmlns='http://www.w3.org/2000/svg'>
