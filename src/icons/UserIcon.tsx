...
export function UserIcon({ title, width, height, color, size, ...props }: SvgIconProps): React.ReactElement {
    return (
        <svg {...props} width={width ?? size ?? 112} height={height ?? size ?? 112} viewBox='0 0 113 112' fill='none' xmlns='http://www.w3.org/2000/svg'>
