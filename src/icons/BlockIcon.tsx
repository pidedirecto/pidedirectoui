...
export function BlockIcon({ title, color, width, height, size, ...props }: SvgIconProps): React.ReactElement {
    return (
        <svg {...props} width={width ?? size ?? 20} height={height ?? size ?? 21} viewBox='0 0 20 21' fill='none' xmlns='http://www.w3.org/2000/svg'>
            <title>{title}</title>
            <path
