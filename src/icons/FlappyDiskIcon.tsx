...
export function FlappyDiskIcon({ color, title, height, width, size, ...props }: SvgIconProps): React.ReactElement {
    return (
        <svg {...props} width={width ?? size ?? 17} height={height ?? size ?? 17} viewBox='0 0 17 17' fill='none' xmlns='http://www.w3.org/2000/svg'>
