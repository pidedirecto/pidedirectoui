...
The `Table` component has customizable props. `title` prop will render a title. `toolbar` prop receives a `React.Element` object, this props is specially useful for rendering button toolbars
