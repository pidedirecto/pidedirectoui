...
This hook allows you to interact with the app theme, it will return the current theme, and you can configure it passing a `Theme` object as a prop, where you can specify various aspects of the theme such as palette colors, font sizes, and more.
You can use it to get the theme in as many as places as you want, but we only recommend to configure the theme in a single point of the application.
