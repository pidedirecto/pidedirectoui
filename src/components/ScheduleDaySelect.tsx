...
export function ScheduleDaySelect({ label, scheduleLabel, value, disabled, error, daysTranslations, onChange, muiTheme, momentInstance }: ScheduleDaySelectProps): React.ReactElement {
    ...
    return (
        <div className={classes.container}>
            ...
            <div className={classes.inputSection}>
                ...
                <div className={classes.inputsContainer}>
                    <TimePicker name='from' value={formatHoursToDate(openingTime)} onChange={handleFromInput} disabled={disabled} muiTheme={muiTheme} momentInstance={momentInstance} />
                    <TimePicker name='to' value={formatHoursToDate(closingTime)} onChange={handleToInput} disabled={disabled} muiTheme={muiTheme} momentInstance={momentInstance} />
                </div>
            </div>
        </div>
    );
