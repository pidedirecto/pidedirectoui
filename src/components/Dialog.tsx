...
export function Dialog({ open, loading, keepMounted, onClose, title, position, children, classes: classesProp, 'data-testid': dataTestid }: DialogProps): React.ReactElement {
    ...
    return createPortal(
        ...
        >
            ...
            <div aria-modal={true} role={'dialog'} aria-labelledby='dialog-title' className={classNames(classes.dialogContent, classesProp?.dialog)} data-position={position} data-testid={dataTestid}>
                {loading && (
