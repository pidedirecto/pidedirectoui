...
function registerValidSW(swUrl, config) {
  console.log(`navigator.serviceWorker.register(${swUrl})`);
  navigator.serviceWorker
    .register(swUrl)
    .then((registration) => {
      console.log(`navigator.serviceWorker.register(${swUrl}) registered`);
      ...
      registration.onupdatefound = () => {
        ...
        installingWorker.onstatechange = () => {
          console.log(`installingWorker.onstatechange state=${installingWorker.state}`);
          if (installingWorker.state === 'installed') {
            ...
            if (navigator.serviceWorker.controller) {
              ...
              console.log(`else navigator.serviceWorker.controller`);
