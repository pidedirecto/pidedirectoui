...
export function FormDateTimePicker({ name, label, helperText, defaultValue, disabled, required, rules, muiTheme, momentInstance, classes }: FormDateTimePickerProps): React.ReactElement {
    const {
        errors,
        control,
